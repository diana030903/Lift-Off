...
// const Sidebar = () => {
//   return (
//     <ul className="menu bg-[#181825] rounded-box gap-y-6">
//       <li>
...
//       </li>
//       <li>
//         <Link to="/projects" className="tooltip tooltip-right" data-tip="Projects">
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
//             className="h-5 w-5"
//             fill="none"
...
const Sidebar = () => {
  return (
    <ul className="menu bg-[#181825] rounded-box">
  <li>
